...
hist.title = "How Many Items do we get From Opening 1000 Loot Boxes?"
...
hist.x_title = " Number of Items From Loot Boxes" # displays at the bottom of the chart
hist.y_title = "How Often did we get Those Number of Items"
